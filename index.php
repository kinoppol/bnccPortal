...
<body data-menu="vertical-menu" class="vertical-layout vertical-menu 2-columns container boxed-layout menu-collapsed" style="display: none;">
<div class="container-fluid">
	<section id="minimal-statistics">
        <div class="row">
          <div class="col-8 mt-3 mb-1">
            <h4 class="text-uppercase">วิทยาลัยพณิชยการบางนา : Bangna Commercial College.</h4>
            <p>อาชีวศึกษากรุงเทพมหานคร : Institute of Vocational Education, Bangkok.</p>
          </div> 
          <div class="col-4 mt-3 mb-1" style="text-align:center">
          <p>โหมดกลางคืน</p>
          <label class="switch">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="https://www.bncc.ac.th/web/category/ข่าวประชาสัมพันธ์/">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="https://www.bncc.ac.th/web/ข้อมูลพื้นฐานสถานศึกษา/">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="https://www.bncc.ac.th/web/ติดต่อเรา/">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="align-self-center">
                      <i class="icon-location-pin danger font-large-2 float-left"></i>
                    </div>
                    <div class="media-body text-right">
                      <h3>ติดต่อเรา</h3>
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="https://www.bncc.ac.th/web/category/ภาพกิจกรรม/">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="danger">ภาพกิจกรรม</h3>
                      <span>Pictures</span>
                    </div>
                    <div class="align-self-center">
                      <i class="icon-picture danger font-large-2 float-right"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="#deptBox" data-toggle="modal" data-target="#deptBox">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="warning">แผนกวิชา</h3>
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="#deptBox" data-toggle="modal" data-target="#secBox">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="primary">หน่วยงานภายใน</h3>
                      <span>Section</span>
                    </div>
                    <div class="align-self-center">
                      <i class="icon-organization primary font-large-2 float-right"></i>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="primary">ระบบ RMS</h3>
                      <span>RMS System</span>
                    </div>
                    <div class="align-self-center">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="https://std2018.vec.go.th">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="warning">ระบบ STD2018</h3>
                      <span>STD2018 System</span>
                    </div>
                    <div class="align-self-center">
                      <i class="icon-people warning font-large-2 float-right"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="https://print.bncc.ac.th">
            <div class="card">                
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="success">ระบบพิมพ์เอกสาร</h3>
                      <span>Bangna Print Service</span>
                    </div>
                    <div class="align-self-center">
                      <i class="icon-printer success font-large-2 float-right"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-xl-3 col-sm-6 col-12">
                <a href="http://web.bncc.ac.th/site/">
            <div class="card">
              <div class="card-content">
                <div class="card-body">
                  <div class="media d-flex">
                    <div class="media-body text-left">
                      <h3 class="danger">เว็บไซต์นักศึกษา</h3>
...
<div class="grey-bg container-fluid">
    <section id="minimal-statistics">
      <div class="row d-flex justify-content-center ">
        <div class="col-xl-3 col-sm-6 col-12"> 
              <a href="https://www.bncc.ac.th/web/">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <div class="media d-flex">
                  <div class="align-self-center">
                    <i class="icon-login primary font-large-2 float-left"></i>
                  </div>
                  <div class="media-body text-right">
                    <h3>เข้าสู่เว็บไซต์</h3>
...
<div class="text-center p-3">
    © <?php print date('Y'); ?> Copyright: <a href="https://bncc.ac.th/">www.bncc.ac.th</a><br>พัฒนาและดูแลระบบโดย งานศูนย์ข้อมูลสารสนเทศ ฝ่ายแผนงานและความร่วมมือ วิทยาลัยพณิชยการบางนา
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">แผนกวิชา</h5>
...
<div class="modal modal-container" tabindex="-1" role="dialog" id="secBox" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">หน่วยงานภายใน</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal" tabindex="-1" role="dialog" id="evaBox" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <div class="d-grid gap-2">
        <a href="http://eva.bncc.ac.th/eva/?p=authen/login/form/student/" class="btn btn-warning btn-block">ระบบรายงานผลการเรียน</a>
        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">ปิด</button>
